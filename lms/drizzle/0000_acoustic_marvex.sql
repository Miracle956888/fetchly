...
CREATE TYPE "public"."instructor_assignment" AS ENUM('lead', 'instructor');--> statement-breakpoint
CREATE TYPE "public"."language" AS ENUM('html', 'css', 'javascript', 'typescript', 'python', 'cpp', 'node', 'sql', 'shell');--> statement-breakpoint
...
CREATE TABLE "course_instructors" (
	...
	"assignment_role" "instructor_assignment" DEFAULT 'instructor' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "quiz_attempt_answers" ADD CONSTRAINT "quiz_attempt_answers_option_id_question_options_id_fk" FOREIGN KEY ("option_id") REFERENCES "public"."question_options"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "certificates" ADD CONSTRAINT "certificates_completion_id_course_completions_id_fk" FOREIGN KEY ("completion_id") REFERENCES "public"."course_completions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "activity_records" ADD CONSTRAINT "activity_records_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "course_instructors_course_user_uq" ON "course_instructors" USING btree ("course_id","user_id");--> statement-breakpoint
CREATE INDEX "course_instructors_user_id_idx" ON "course_instructors" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "courses_category_id_idx" ON "courses" USING btree ("category_id");--> statement-breakpoint
CREATE INDEX "courses_status_idx" ON "courses" USING btree ("status");--> statement-breakpoint
CREATE INDEX "courses_difficulty_idx" ON "courses" USING btree ("difficulty");--> statement-breakpoint
CREATE INDEX "exercises_lesson_id_idx" ON "exercises" USING btree ("lesson_id");--> statement-breakpoint
CREATE UNIQUE INDEX "learning_path_courses_path_course_uq" ON "learning_path_courses" USING btree ("learning_path_id","course_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "quiz_attempt_answers_attempt_question_uq" ON "quiz_attempt_answers" USING btree ("attempt_id","question_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "course_completions_user_course_uq" ON "course_completions" USING btree ("user_id","course_id");--> statement-breakpoint
...
CREATE INDEX "enrollments_last_activity_idx" ON "enrollments" USING btree ("last_activity_at");--> statement-breakpoint
CREATE INDEX "exercise_attempts_user_id_idx" ON "exercise_attempts" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "exercise_attempts_exercise_id_idx" ON "exercise_attempts" USING btree ("exercise_id");--> statement-breakpoint
...
CREATE INDEX "activity_user_created_idx" ON "activity_records" USING btree ("user_id","created_at");--> statement-breakpoint
CREATE INDEX "activity_type_created_idx" ON "activity_records" USING btree ("type","created_at");--> statement-breakpoint
